    ...
    <>
      ...
      <Table
        ...
        columns={[
          ...
          {
            title: t("clients"),
            render: (_, record: CaseItem) => record.client?.name ?? "-",
          },
              ...
              >
                <Select
                  ...
                  options={[
                    ...
                    {
                      value: "in_progress",
                      label: <Tag color="blue">in_progress</Tag>,
                    },
                    {
                      value: "submitted",
                      label: <Tag color="gold">submitted</Tag>,
                    },
                    {
                      value: "completed",
                    ...
                    {
                      value: "rejected",
                      label: <Tag color="red">rejected</Tag>,
                    },
                  ]}
                />
              </Popconfirm>
